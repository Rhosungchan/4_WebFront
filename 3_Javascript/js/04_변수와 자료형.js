var str = "JS 코드를 함수가 아닌" + "JS 파일 또는 script 태그 내부에 바로 작성하면"
        +"HTML 랜더링 시 바로 수행된다."
...
function typeTest(){
    ...
    if(temp1 == 100){
        let temp2 = 200;
        const tmep3 = 300;
        // temp3 = 400; // 상수형 변수에 값을 할당해서 error
    }
    ...
    //========================
    // const neme2; // 상수는 선언과 동시에 초기화가 필수
    let name; // undefined
    ...
    typeBox.innerHTML += "<br>user.a : " + user.a[2];
