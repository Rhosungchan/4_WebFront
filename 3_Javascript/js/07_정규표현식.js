...
document.getElementById("check1").addEventListener("click",function(){
    ...
    const str2 = "java, db, html, css, js. spring, mybatis, jdbc 모두 사용 중입니다.";
...
document.getElementById("check2").addEventListener("click",function(){
    ...
    div1.innerHTML += "/[abcd]/, qwety : " + regEx1.test("qwety") + "<hr>";
...
document.getElementById("inputName").addEventListener("keyup",function(){ // 시험에 나올 수 있음
