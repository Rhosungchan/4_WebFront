...
document.getElementById("add").addEventListener("click",function(){
    ...
    // step 4) div > input > span 조립 ---------------------------------------
    // div.append(input);
    // div.append(span);
    
    div.append(input, span);
    
    // step 5) .container에 div를 마지막 자식으로 추가 ---------------------------------------
...
// "remove"클래스 요소를 모두 얻어와 for문으로 하나씩 접근해서
// click 이벤트 동작을 추가

// 실행되지 않음...
// Why? 처음 HTML 문서 해석시 remove라는 클래스를 가진 요소가 존재하지 않기 때문에
